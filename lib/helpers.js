 ...
 * Setup
 *
 * This is the style and configuration of a FE Application.
 * returns object with contents of FE.json and application style
 *
 *   {
...
exports.setup = function (projectPath, env) {
  ...
  try{
    var configPath  = path.join(projectPath, "feserver.json")
