...
exports.serveIndex = require('serve-index')
...
exports.notMultihostURL = function (req, rsp, next) {
  ...
  if (hostname == '127.0.0.1' || hostname == 'localhost') {
    rsp.statusCode = 307
    rsp.setHeader('Location', 'http://fe-server.nu' + port)
    rsp.end('redirecting you to http://fe-server.nu' + port)
...
var reservedDomains = ['fe-server.io', 'fe-serverdev.io', 'fe-serverapp.io'];
...
var notFound = exports.notFound = function (req, rsp, next) {
  console.log(req.method, req.url, "404".yellow);
...
/**
 * Opens the (optional) fe-server.json file and sets the config settings.
 */
